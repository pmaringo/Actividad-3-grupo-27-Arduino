...
void setup() {
  ...
  Serial.println(F("UNIR Actividad 2 - Ascensor ACME v4.3"));
  Serial.println(F("[MOD v4.3] Fuzzy + SCAN sin oscilaciones (histeresis de planta)"));
  Serial.println(F(""));
  ...
  Serial.println(F("Sistema ascensor v4.3 LISTO!"));
  Serial.println(F("------------------------------------"));  
}
